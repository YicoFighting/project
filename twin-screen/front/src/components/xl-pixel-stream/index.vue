...
<template>
  <div id="playerUI" class="noselect pixel-stream">
    <div id="player"></div>
    <div id="overlay">
      <div id="controls">
        <button class="tooltip" onclick="fullscreen()" id="fullscreen-btn">
          <object
            data="images/Minimize.svg"
            type="image/svg+xml"
            id="minimize"
          ></object>
          <object
            data="images/Maximize.svg"
            type="image/svg+xml"
            id="maximize"
          ></object>
        ...
        <div class="panel">
          ...
          <div id="content">
            ...
            <div id="toggleControl" class="setting">
              <div class="settings-text" id="control-scheme-text">
                Control Scheme
              </div>
            ...
            <div id="toggleCursor" class="setting">
              <div class="settings-text" id="cursor-text">
                Hide Browser Cursor
              </div>
              <label class="btn-overlay">
                <label class="tgl-switch">
              ...
              <div id="webrtcParamsContainer" class="collapse">
                <div class="form-group">
                  ...
                  <input
                    ...
                    max="999"
                  />
                  <label for="webrtc-min-bitrate-text"
                    >Min bitrate (kbps)</label
                  >
                  <input
                    type="number"
                    class="form-control"
                    ...
                    max="100000"
                  />
                  <label for="webrtc-max-bitrate-text"
                    >Max bitrate (kbps)</label
                  >
                  <input
                    type="number"
                    class="form-control"

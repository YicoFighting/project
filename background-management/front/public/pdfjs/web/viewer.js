      ...
      const PDFViewerApplication = {
        ...
        async _initializeViewerComponents() {
          ...
          const isOffscreenCanvasSupported =
            _app_options.AppOptions.get("isOffscreenCanvasSupported") &&
            _pdfjsLib.FeatureTest.isOffscreenCanvasSupported;
          const pageColors =
          ...
          const altTextManager = appConfig.altTextDialog
            ? new _webAlt_text_manager.AltTextManager(
          ...
          if (appConfig.annotationEditorParams) {
            if (
              ...
              if (
                _app_options.AppOptions.get("enableStampEditor") &&
                isOffscreenCanvasSupported
              ) {
                appConfig.toolbar?.editorStampButton?.classList.remove(
                  "hidden"
                );
              }
        ...
        async run(config) {
          ...
          file =
            params.get("file") ?? _app_options.AppOptions.get("defaultUrl");
          ...
          if (jsActions) {
            ...
            for (const name in jsActions) {
              ...
              triggerAutoPrint = jsActions[name].some((js) =>
                _ui_utils.AutoPrintRegExp.test(js)
              );
            }
          }
          if (triggerAutoPrint) {
        ...
        if (ERROR_STACK_INSTALLABLE) {
          if (captureStackTrace) captureStackTrace(error, C);
            ...
            createNonEnumerableProperty(
              error,
              "stack",
              clearErrorStack(stack, dropEntries)
            );
        }
      };
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class AltTextManager {
        ...
        constructor(_ref, container, overlayManager, eventBus) {
          ...
          optionDescription.addEventListener(
            "change",
            this.#boundUpdateUIState
          );
          optionDecorative.addEventListener("change", this.#boundUpdateUIState);
          this.#overlayManager.register(dialog);
        }
        get _elements() {
          return (0, _pdfjsLib.shadow)(this, "_elements", [
        ...
        #setAttributes(structElement, htmlElement) {
          ...
          if (alt !== undefined) {
            htmlElement.setAttribute(
              "aria-label",
              (0, _ui_utils.removeNullCharacters)(alt)
            );
          }
          if (id !== undefined) {
          ...
          if (lang !== undefined) {
            htmlElement.setAttribute(
              "lang",
              (0, _ui_utils.removeNullCharacters)(lang, true)
            );
          }
        }
        #walk(node) {
      ...
      class Toolbar {
            ...
            },
            {
              ...
              eventDetails: {
                get mode() {
                  ...
                  return classList.contains("toggled")
                    ? _pdfjsLib.AnnotationEditorType.NONE
                    : _pdfjsLib.AnnotationEditorType.STAMP;
                },
              },
            },
          ];
        ...
        #bindEditorToolsListener(_ref) {
          ...
          const editorModeChanged = (_ref2) => {
            ...
            (0, _ui_utils.toggleCheckedBtn)(
              editorStampButton,
              mode === _pdfjsLib.AnnotationEditorType.STAMP,
              editorStampParamsToolbar
            );
